...
document.querySelector(".fordele").textContent = "Fordele ved elbiler"
function circle1(){
    console.log("circle1")
    animateBoxes();
    ...
    document.querySelector("#efficiency").textContent = "Effektivitet";
    document.querySelector("#requirement").textContent = "Fordele";
}
